...
ffmpeg -loglevel error -y \
    -i "$CAPTURE" -i "$VOICE" \
    -filter_complex "[0:v]scale=1920:1080:force_original_aspect_ratio=decrease,pad=1920:1080:-1:-1:color=black,fps=30,setsar=1,crop=1890:980:0:0,pad=1920:1080:0:0:color=0x0a0a0c[v];[1:a]apad=whole_dur=${CAP_LEN},aformat=channel_layouts=stereo:sample_rates=48000[a]" \
