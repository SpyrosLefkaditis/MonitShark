...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card p-6 shadow-card-lg transition ease-in-out border-border data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
  {
    variants: {
      side: {
